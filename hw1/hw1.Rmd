...
importsCAN <- data.3 %>%
  filter(LOCATION == 'CAN',
         MEASURE == 'GYSA', # GPSA or GYSA ?
         SUBJECT == 'P7')

hpCAN <- hpfilter(importsCAN$Value, freq = 1600, type = 'lambda')

importsCAN$Trend <- hpCAN$trend

colours <-
  c('Import wedge' = '#1e40ca',
    'Trend' = '#00a2ed')

ggplot() +
  geom_line(aes(
    x = as.Date(as.yearqtr(importsCAN$TIME, format = '%Y-Q%q')),
    y = importsCAN$Value,
    group = 1,
    colour = 'Import wedge'
  )) +
  ...
  geom_rect(aes(
    xmin = as.Date(as.yearqtr('2000-Q4', format = '%Y-Q%q')),
    xmax = as.Date(as.yearqtr('2002-Q2', format = '%Y-Q%q')),
    ymin = -30,
    ymax = 30
  ), alpha = 0.5) +
  geom_rect(aes(
    xmin = as.Date(as.yearqtr('2008-Q3', format = '%Y-Q%q')),
    xmax = as.Date(as.yearqtr('2009-Q4', format = '%Y-Q%q')),
    ymin = -30,
    ymax = 30
  ), alpha = 0.5) +
  labs(title = 'Canada',
...
hpMEX <- hpfilter(importsMEX$Value, freq = 1600, type = 'lambda')

importsMEX$Trend <- hpMEX$trend
...
ggplot() +
  geom_line(aes(
    x = as.Date(as.yearqtr(importsMEX$TIME, format = '%Y-Q%q')),
    y = importsMEX$Value,
    group = 1,
    colour = 'Import wedge'
  )) +
  ...
  geom_rect(aes(
    xmin = as.Date(as.yearqtr('1994-Q4', format = '%Y-Q%q')),
    xmax = as.Date(as.yearqtr('1996-Q1', format = '%Y-Q%q')),
    ymin = -30,
    ymax = 30
  ), alpha = 0.5) +
  geom_rect(aes(
...
hpUSA <- hpfilter(importsUSA$Value, freq = 1600, type = 'lambda')

importsUSA$Trend <- hpUSA$trend
...
ggplot() +
  geom_line(aes(
    x = as.Date(as.yearqtr(importsUSA$TIME, format = '%Y-Q%q')),
    y = importsUSA$Value,
    group = 1,
    colour = 'Import wedge'
  )) +
  ...
  geom_rect(aes(
    xmin = as.Date(as.yearqtr('2001-Q2', format = '%Y-Q%q')),
    xmax = as.Date(as.yearqtr('2002-Q2', format = '%Y-Q%q')),
    ymin = -30,
    ymax = 30
  ), alpha = 0.5) +
  geom_rect(aes(
    xmin = as.Date(as.yearqtr('2008-Q1', format = '%Y-Q%q')),
    xmax = as.Date(as.yearqtr('2010-Q1', format = '%Y-Q%q')),
    ymin = -30,
    ymax = 30
  ), alpha = 0.5) +
